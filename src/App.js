      ...
      <React.Fragment>
        ...
        <main>
            <ul className="left-fixed fixed-ad">
                <li><a href="http://www.dalma.am/hy/home" target='_blank'><img src={Dalma} alt=""/></a></li>
                <li><a href="https://riomall.am" target='_blank'><img src={Rio} alt=""/></a></li>
                <li><a href="http://www.tashirpizza.am" target='_blank'><img src={Tashir} alt=""/></a></li>
                <li><a href="https://www.erebuni-plaza.am/" target='_blank'><img src={Erebuni} alt=""/></a></li>
            </ul>
